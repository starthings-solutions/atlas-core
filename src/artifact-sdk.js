...
export function createArtifactSdk(
  ...
  function highlightElement(el) {
    if (!el) return;
    el.style.outline = "var(--atlas-annotate-outline,2px solid #6fc7c2)";
    el.style.outlineOffset = "var(--atlas-annotate-offset,3px)";
  }
  ...
  function ensureShadow() {
    ...
    style.textContent = `:host{all:initial;position:fixed;z-index:2147483647;left:0;top:0;color-scheme:dark;--void:#000000;--surface:#080808;--surface-2:#101010;--rule:#1b1b1b;--dim:#2a2a2a;--rule-2:#2e2e2e;--ink-3:#787878;--ink-2:#a3a3a3;--ink:#ffffff;--hollow:#6a6a6a;--app-ink:#f8f4eb;--app-feedback:#ffb386;--app-risk:#f87171;--app-pending:#f2c14e;--app-activity:#6fc7c2;--ink-900:var(--void);--ink-800:var(--surface);--ink-700:var(--void);--ink-600:var(--surface-2);--steel-700:var(--rule);--steel-600:var(--rule-2);--steel-500:var(--ink-3);--steel-400:var(--ink-3);--steel-300:var(--ink-3);--steel-200:var(--ink-2);--steel-100:var(--ink-2);--cream-50:var(--app-ink);--cream-100:var(--app-ink);--cream-200:var(--app-ink);--brass-500:var(--app-activity);--brass-400:var(--app-activity);--brass-ink:var(--void);--bg:var(--ink-900);--bg-panel:var(--ink-800);--bg-elevated:var(--ink-600);--fg:var(--cream-100);--fg-faint:var(--steel-300);--border:var(--steel-600);--accent:var(--app-activity);--accent-hover:var(--app-activity);--font-sans:"Archivo",ui-sans-serif,system-ui,"Segoe UI",Helvetica,Arial,sans-serif;--font-mono:"IBM Plex Mono",ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;--radius-md:2px;--radius-xl:3px;--shadow-floating:none;font-family:var(--font-sans)}*{box-sizing:border-box}:focus-visible{outline:2px solid var(--accent);outline-offset:3px}.atlas-text-highlight{position:fixed;pointer-events:none;background:rgb(111 199 194/.28);border-radius:2px;box-shadow:0 0 0 1px rgb(111 199 194/.45)}.atlas-annotation-card{position:fixed;width:min(320px,calc(100vw - 24px));padding:12px;border-radius:var(--radius-xl);background:var(--bg-panel);color:var(--fg);border:1px solid var(--accent);box-shadow:var(--shadow-floating);font:14px/1.4 var(--font-sans)}.atlas-heading{font-weight:700;margin-bottom:6px}.atlas-annotation-card textarea{width:100%;min-height:86px;resize:vertical;border-radius:var(--radius-md);border:1px solid var(--border);background:var(--bg);color:var(--fg);padding:9px;font:inherit;font-family:var(--font-sans)}.atlas-annotation-card textarea::placeholder{color:var(--fg-faint)}.atlas-annotation-card .atlas-hint{margin-top:6px;font-size:11px;color:var(--fg-faint)}.atlas-annotation-card .atlas-hint-alert{color:var(--app-risk);font-weight:700}.atlas-annotation-card .atlas-row{display:flex;gap:8px;justify-content:flex-end;margin-top:8px}.atlas-annotation-card button{border:0;border-radius:var(--radius-md);padding:8px 10px;font-family:var(--font-sans);font-size:13px;font-weight:700;cursor:pointer}.atlas-annotation-card .atlas-send{background:var(--app-ink);color:var(--void)}.atlas-annotation-card .atlas-send:hover{box-shadow:inset 0 0 0 1px var(--void)}.atlas-annotation-card .atlas-cancel{background:var(--steel-700);color:var(--fg)}.atlas-annotation-card.is-dropping{outline:2px dashed var(--accent);outline-offset:3px}.atlas-attachments{display:flex;flex-direction:column;gap:6px;margin-top:8px;max-height:176px;overflow-y:auto}.atlas-attachment-chip{display:flex;align-items:center;gap:8px;padding:6px;border-radius:var(--radius-md);background:var(--bg);border:1px solid var(--border)}.atlas-attachment-chip.is-error{border-color:var(--app-risk)}.atlas-attachment-thumb{width:32px;height:32px;border-radius:2px;object-fit:cover;background:var(--ink-700);flex:0 0 auto}.atlas-attachment-thumb-empty{display:inline-block}.atlas-attachment-body{display:flex;flex-direction:column;gap:1px;min-width:0;flex:1 1 auto}.atlas-attachment-name{font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.atlas-attachment-status{font-size:11px;color:var(--fg-faint)}.atlas-attachment-status-error{color:var(--app-risk)}.atlas-attachment-retry{flex:0 0 auto;padding:4px 8px;font-size:11px;font-weight:700;border-radius:2px;background:var(--steel-700);color:var(--fg);cursor:pointer;border:0}.atlas-attachment-remove{flex:0 0 auto;display:flex;align-items:center;justify-content:center;width:22px;height:22px;padding:0!important;border-radius:2px;background:transparent;color:var(--ink-2);cursor:pointer;border:0}.atlas-attachment-remove:hover{background:var(--rule-2);color:var(--fg)}.atlas-attach-row{margin-top:8px}.atlas-attach{display:inline-flex;align-items:center;gap:6px;padding:6px 9px!important;background:var(--steel-700)!important;color:var(--fg)!important;font-size:12px!important}.atlas-attach:hover{background:var(--steel-600)!important}.atlas-reveal-marker{position:fixed;pointer-events:none;border:2px solid var(--accent);border-radius:2px;box-shadow:0 0 0 4px rgb(111 199 194/.22);animation:atlas-reveal-pulse 2.4s var(--ease,ease-out) forwards}@keyframes atlas-reveal-pulse{0%{opacity:0}12%{opacity:1}70%{opacity:1}100%{opacity:0}}`;
