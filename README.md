...
- **Server port** - Set `ATLAS_CORE_PORT` to choose the server port; it defaults to `4387`.
...
| `atlas-core update`             | Check for or apply the latest npm release through the AXI SDK self-updater.                                                                                                                                                                                                                                                                                   |
| `atlas-core <html-file>`        | Open or resume a Atlas Core Editor session, with the open-time layout gate enabled by default. Unresolved layout issues from earlier in the session are preserved. Refuses to reopen a session the user explicitly ended from the browser unless `--reopen` is passed.                                                                                        |
...
| `atlas-core server`             | Run the local Atlas Core Editor server.                                                                                                                                                                                                                                                                                                                       |
